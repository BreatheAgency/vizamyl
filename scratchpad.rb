...
User.new(locale: 'en-us', invite_code: 'tomography', salutation: 'Dr', first_name: 'Example', last_name: 'Example', email: 'en-us-super-user@readvizamyl.com', password: 'Ko94Pj1Yd4tXh2i', password_confirmation: 'Ko94Pj1Yd4tXh2i', institution: 'Example', super_user: true, terms_and_conditions_opt_in: true).save!
