class Users::EnrolController < ApplicationController
  ...
  private
    ...
    def basic_params(step=nil)
      permitted_attributes = [:id, :form_step, :salutation, :first_name, :last_name, :locale, :email, :password, :password_confirmation, :marketing_overall_opt_in, :marketing_email_opt_in, :marketing_post_opt_in, :marketing_representative_opt_in, :terms_and_conditions_opt_in, :institution, :invite_code]
