...
def initialize(user, from_active_admin = false)
  ...
  font('geinspira')
  image(Rails.root.join("app/assets/images/course-completion-#{I18n.locale}-v#{PDF_IMAGE_VERSION}.jpg"), at: [bounds.absolute_left, PDF::Core::PageGeometry::SIZES['LETTER'][1] - bounds.absolute_bottom], fit: PDF::Core::PageGeometry::SIZES['LETTER'])
  left = 68
  top = 415
  height = 31.5
  margin = 2
...
def initialize(user, from_active_admin = false)
  ...
  font('geinspira')
  image(Rails.root.join("app/assets/images/course-completion-#{I18n.locale}-v#{PDF_IMAGE_VERSION}.jpg"), at: [bounds.absolute_left, PDF::Core::PageGeometry::SIZES['A4'][1] - bounds.absolute_bottom], fit: PDF::Core::PageGeometry::SIZES['A4'])
  left = 68
