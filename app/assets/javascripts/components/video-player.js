Course.VideoPlayerComponent = Ember.Component.extend({
  ...
  updateSource: function() {
    ...
    this.player.src([
      { type: 'application/vnd.apple.mpegurl', src: '//vizamyl-live.s3.amazonaws.com/videos/' + this.get('source') + '/playlist.m3u8' },
      { type: 'video/mp4', src: '//vizamyl-live.s3.amazonaws.com/videos/' + this.get('source') + '/web.mp4' },
      { type: 'video/webm', src: '//vizamyl-live.s3.amazonaws.com/videos/' + this.get('source') + '/web.webm' }
    ]);
    this.player.ga({
